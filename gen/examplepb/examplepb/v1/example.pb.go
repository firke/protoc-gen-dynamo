...
// 	protoc        (unknown)
// source: examplepb/v1/example.proto
...
const (
	BasicEnum_BASIC_ENUM_UNSPECIFIED BasicEnum = 0
	BasicEnum_BASIC_ENUM_FIRST       BasicEnum = 1
	BasicEnum_BASIC_ENUM_SECOND      BasicEnum = 2
)

// Enum value maps for BasicEnum.
var (
	BasicEnum_name = map[int32]string{
		0: "BASIC_ENUM_UNSPECIFIED",
		1: "BASIC_ENUM_FIRST",
		2: "BASIC_ENUM_SECOND",
	}
	BasicEnum_value = map[string]int32{
		"BASIC_ENUM_UNSPECIFIED": 0,
		"BASIC_ENUM_FIRST":       1,
		"BASIC_ENUM_SECOND":      2,
	}
)
...
func (BasicEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_examplepb_v1_example_proto_enumTypes[0].Descriptor()
}

func (BasicEnum) Type() protoreflect.EnumType {
	return &file_examplepb_v1_example_proto_enumTypes[0]
}
...
func (x *Store) Reset() {
	*x = Store{}
	mi := &file_examplepb_v1_example_proto_msgTypes[0]
...
func (x *User) Reset() {
	*x = User{}
	mi := &file_examplepb_v1_example_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *User) GetAnEnum() BasicEnum {
	...
	return BasicEnum_BASIC_ENUM_UNSPECIFIED
}
...
func (x *User) ClearAnEnum() {
	...
	x.xxx_hidden_AnEnum = BasicEnum_BASIC_ENUM_UNSPECIFIED
}
...
func (x *StoreV2) Reset() {
	*x = StoreV2{}
	mi := &file_examplepb_v1_example_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UserV2) Reset() {
	*x = UserV2{}
	mi := &file_examplepb_v1_example_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_examplepb_v1_example_proto protoreflect.FileDescriptor

const file_examplepb_v1_example_proto_rawDesc = "" +
	"\n" +
	"\x1aexamplepb/v1/example.proto\x12\fexamplepb.v1\x1a\x16dynamo/v1/dynamo.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xec\x05\n" +
	"\x05Store\x12 \n" +
	...
	"\ttenant_id\n" +
	"\x06idp_id\x12\aan_enum\"\x04\b\x01\x10@*T\n" +
	"\tBasicEnum\x12\x1a\n" +
...
var file_examplepb_v1_example_proto_goTypes = []any{
...
var file_examplepb_v1_example_proto_depIdxs = []int32{
...
func init() { file_examplepb_v1_example_proto_init() }
func file_examplepb_v1_example_proto_init() {
	if File_examplepb_v1_example_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_examplepb_v1_example_proto_rawDesc), len(file_examplepb_v1_example_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_examplepb_v1_example_proto_goTypes,
		DependencyIndexes: file_examplepb_v1_example_proto_depIdxs,
		EnumInfos:         file_examplepb_v1_example_proto_enumTypes,
		MessageInfos:      file_examplepb_v1_example_proto_msgTypes,
	}.Build()
	File_examplepb_v1_example_proto = out.File
	file_examplepb_v1_example_proto_goTypes = nil
	file_examplepb_v1_example_proto_depIdxs = nil
}
